...
async function getAggregatedFrictionData(radius, timeAggregation, startTime, endTime, reporterOrganization, maxFriction) {
    await $.getJSON("/api/getAggregatedFrictionData", {radius, timeAggregation, startTime, endTime, reporterOrganization, maxFriction}, function(data) {
